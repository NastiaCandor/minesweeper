...
function buildFooter() {
  ...
  const creatotIcon = document.createElement('div');
  const creatorName = document.createElement('p');
  const footerItemSchool = document.createElement('li');
  const schoolLink = document.createElement('a');
  const schoolIcon = document.createElement('div');
  // const schoolIconObject = document.createElement('object');
  const schoolName = document.createElement('p');
  // const schoolCaption = document.createElement('li');
...
function buildGame() {
  ...
  gameSection.className = 'minesweeper';

  gamePanel.className = 'minesweeper__panel';
  gameDiv.className = 'minesweeper__game';
  main.className = 'main';
  wrapper.className = 'wrapper';

  gameSection.appendChild(gamePanel);
